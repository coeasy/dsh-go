...
| 3 | [deepseek-harness-desktop](https://github.com/dsh-tauri/deepseek-harness-desktop) | 2.4k | TypeScript | 2026-09-21 | DeepSeek Harness Tauri 桌面版 \| Only 5mb ins… |
| 4 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 3.1k | TypeScript | 2026-09-21 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实… |
| 5 | [dsh_desktop](https://github.com/myYangyunfan/dsh_desktop) | 675 | JavaScript | 2026-09-21 | DeepSeek Harness (dsh) Windows desktop cli… |
| 6 | [dsh-market](https://github.com/dsh-market/dsh-market) | 4.3k | TypeScript | 2026-09-21 | The plugin market inside DeepSeek Harness … |
| 7 | [dsh-im](https://github.com/xmanrui/dsh-im) | 1.4k | JavaScript | 2026-09-21 | 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信… |
| 8 | [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 445 | JavaScript | 2026-09-21 | 基于 DeepSeek Harness（DSH）的 SillyTavern 类文字游… |
...
| 10 | [dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) | 503 | Kotlin | 2026-09-21 | dsh 安卓壳 APK——WebView UI + 内嵌 Termux 运行时快照（… |
| 11 | [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 321 | JavaScript | 2026-09-21 | DeepSeek Harness session cost meter plugin… |
| 12 | [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 1.8k | JavaScript | 2026-09-21 | DeepSeek Harness 破甲：让所有模型都能破甲，不同模型可换不同提示词；… |
...
| 14 | [dsh-plugin-radar](https://github.com/AdamPlatin123/dsh-plugin-radar) | 1.5k | Python | 2026-09-21 | DSH Plugin Radar — open-source ecosystem r… |
| 15 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1.1k | JavaScript | 2026-09-21 | Eyes for text-only DeepSeek Harness agents… |
| 16 | [jingyun-dsh](https://github.com/jingyunstudio/jingyun-dsh) | 547 | TypeScript | 2026-09-21 | 基于 Jingyun Studio + DeepSeek Harness (DSH)… |
| 17 | [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 380 | TypeScript | 2026-09-21 | Give DeepSeek Harness a real office enviro… |
| 18 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 471 | TypeScript | 2026-09-21 | GenUI for DeepSeek Harness: interactive UI… |
| 19 | [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 374 | TypeScript | 2026-09-21 | Use ChatGPT (Codex), Claude, and Grok (X P… |
| 20 | [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 854 | TypeScript | 2026-09-21 | The most comprehensive DeepSeek Harness pl… |
