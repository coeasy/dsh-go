...
| 4 | [dsh-market](https://github.com/dsh-market/dsh-market) | 3.2k | TypeScript | 2026-09-05 | The plugin market inside DeepSeek Harness … |
...
| 7 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 331 | TypeScript | 2026-09-05 | Composable three-tier memory control plane… |
| 8 | [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 321 | TypeScript | 2026-09-05 | Use ChatGPT (Codex), Claude, and Grok (X P… |
| 9 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 406 | TypeScript | 2026-09-05 | GenUI for DeepSeek Harness: interactive UI… |
| 10 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1.1k | JavaScript | 2026-09-04 | Eyes for text-only DeepSeek Harness agents… |
| 11 | [dsh-im](https://github.com/xmanrui/dsh-im) | 1.1k | JavaScript | 2026-09-04 | 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信… |
...
| 13 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 853 | TypeScript | 2026-09-04 | [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图… |
| 14 | [dshcode](https://github.com/whitelonng/dshcode) | 712 | TypeScript | 2026-09-04 | Community desktop companion for DeepSeek H… |
| 15 | [dsh-dafeiyu](https://github.com/QCYTSN/dsh-dafeiyu) | 300 | JavaScript | 2026-09-04 | Desktop-native BigFish companion for DeepS… |
| 16 | [dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) | 315 | Kotlin | 2026-09-04 | dsh 安卓壳 APK——WebView UI + 内嵌 Termux 运行时快照（… |
| 17 | [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 976 | C# | 2026-09-04 | DeepSeek 专用破甲插件「无限三代」dsh-infinite-gen-3 — … |
| 18 | [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 544 | TypeScript | 2026-09-04 | DSH 桌面宠物：一行命令装好即用的透明动画小桌宠，支持多开、大小位置随心配置；还内… |
| 19 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 303 | TypeScript | 2026-09-04 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
| 20 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 572 | TypeScript | 2026-09-04 | Chrome sidebar extension that lets DeepSee… |
