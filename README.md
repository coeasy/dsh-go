...
| 3 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1.1k | JavaScript | 2026-09-10 | Eyes for text-only DeepSeek Harness agents… |
| 4 | [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 450 | TypeScript | 2026-09-10 | The most comprehensive DeepSeek Harness pl… |
| 5 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 427 | TypeScript | 2026-09-10 | GenUI for DeepSeek Harness: interactive UI… |
| 6 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2.9k | TypeScript | 2026-09-10 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实… |
| 7 | [deepseek-harness-desktop](https://github.com/dsh-tauri-desk/deepseek-harness-desktop) | 1.8k | Rust | 2026-09-10 | DeepSeek Harness Tauri 桌面版 \| Only 5mb ins… |
| 8 | [dsh-context](https://github.com/bowenliang123/dsh-context) | 1.3k | TypeScript | 2026-09-10 | The best DeepSeek Harness plugin for conte… |
| 9 | [dsh-pentest](https://github.com/howmp/dsh-pentest) | 413 | JavaScript | 2026-09-10 | 面向 DeepSeek Harness（dsh）的渗透测试模式 @CloverSec… |
| 10 | [dsh-im](https://github.com/xmanrui/dsh-im) | 1.2k | JavaScript | 2026-09-10 | 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信… |
| 11 | [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 361 | Python | 2026-09-10 | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖… |
| 12 | [dsh-plugin-radar](https://github.com/AdamPlatin123/dsh-plugin-radar) | 1.5k | Python | 2026-09-09 | DSH Plugin Radar — 开源可自部署的 DSH 插件生态雷达：自动发现… |
| 13 | [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1.2k | JavaScript | 2026-09-09 | DeepSeek v4.1 flash 网络安全红队工具（无限四代） — jailb… |
| 14 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 355 | TypeScript | 2026-09-09 | Composable, view-based memory for DeepSeek… |
| 15 | [dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) | 338 | Kotlin | 2026-09-09 | dsh 安卓壳 APK——WebView UI + 内嵌 Termux 运行时快照（… |
| 16 | [dsh_desktop](https://github.com/myYangyunfan/dsh_desktop) | 648 | JavaScript | 2026-09-09 | DeepSeek Harness (dsh) Windows desktop cli… |
| 17 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1.5k | JavaScript | 2026-09-09 | AgentTeams plugin for DeepSeek Harness |
| 18 | [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 583 | TypeScript | 2026-09-09 | DSH 桌面宠物：一行命令装好即用的透明动画小桌宠，支持多开、大小位置随心配置；还内… |
| 19 | [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 387 | TypeScript | 2026-09-09 | AI image studio for DeepSeek Harness — gen… |
| 20 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 309 | TypeScript | 2026-09-09 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
