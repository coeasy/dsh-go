...
| # | 插件 | ★ Stars | 语言 | 最近更新 | 简介 |
|---|------|---------|------|----------|------|
| 1 | [modlens](https://github.com/liustack/modlens) | 3.9k | TypeScript | 2026-09-07 | The first vision plugin for DeepSeek Harne… |
| 2 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3.5k | TypeScript | 2026-09-11 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/G… |
| 3 | [dsh-context](https://github.com/bowenliang123/dsh-context) | 1.3k | TypeScript | 2026-09-11 | The best DeepSeek Harness plugin for conte… |
| 4 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1.1k | JavaScript | 2026-09-11 | Eyes for text-only DeepSeek Harness agents… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 3k | TypeScript | 2026-09-11 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实… |
| 6 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 436 | TypeScript | 2026-09-11 | GenUI for DeepSeek Harness: interactive UI… |
| 7 | [deepseek-harness-desktop](https://github.com/ningbainb/deepseek-harness-desktop) | 472 | TypeScript | 2026-09-11 | Open-source Windows desktop client and GUI… |
| 8 | [dsh-im](https://github.com/xmanrui/dsh-im) | 1.3k | JavaScript | 2026-09-11 | 通过扫码或机器人凭据把IM机器人接入DeepSeek Harness（支持飞书、微信… |
| 9 | [dsh-mobile-apk](https://github.com/kelai141/dsh-mobile-apk) | 355 | Kotlin | 2026-09-11 | dsh 安卓壳 APK——WebView UI + 内嵌 Termux 运行时快照（… |
| 10 | [dsh-plugin-radar](https://github.com/AdamPlatin123/dsh-plugin-radar) | 1.5k | Python | 2026-09-11 | DSH Plugin Radar — 开源可自部署的 DSH 插件生态雷达：自动发现… |
| 11 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 361 | TypeScript | 2026-09-11 | Composable, view-based memory for DeepSeek… |
| 12 | [deepseek-harness-desktop](https://github.com/dsh-tauri-desk/deepseek-harness-desktop) | 1.9k | TypeScript | 2026-09-11 | DeepSeek Harness Tauri 桌面版 \| Only 5mb ins… |
| 13 | [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 397 | Python | 2026-09-11 | 基于dsh web实现的多种模式，目的是服务于redteam进行授权的安全研究，覆盖… |
| 14 | [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 2k | TypeScript | 2026-09-11 | Whale Girl skin series for DeepSeek Harnes… |
| 15 | [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 604 | TypeScript | 2026-09-11 | DSH 桌面宠物：一行命令装好即用的透明动画小桌宠，支持多开、大小位置随心配置；还内… |
| 16 | [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 399 | TypeScript | 2026-09-11 | AI image studio for DeepSeek Harness — gen… |
| 17 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1.6k | JavaScript | 2026-09-11 | AgentTeams plugin for DeepSeek Harness |
| 18 | [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 315 | TypeScript | 2026-09-11 | Mimir — 一站式科研工作台插件：LaTeX 论文边写边编译、arXiv 文献管… |
| 19 | [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 617 | TypeScript | 2026-09-11 | The most comprehensive DeepSeek Harness pl… |
| 20 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 630 | TypeScript | 2026-09-11 | Chrome sidebar extension that lets DeepSee… |
