...
export const MESSAGES = {
  en: {
    ...
    footer_summary: 'DSH Marketplace · Registry V4 · local package execution only', registry_revision: 'Registry revision',
  },
  'zh-CN': {
    ...
    footer_summary: 'DSH 生态市场 · Registry V4 · 仅本地执行包操作', registry_revision: 'Registry 版本',
  },
  ja: {
    ...
    local_install_notice: 'インストールは明示的な確認後にローカル DSH Runtime のみで実行されます。', stars: 'Stars', updated: '更新', back_marketplace: '← マーケット', footer_summary: 'DSH Marketplace · Registry V4 · ローカル実行のみ', registry_revision: 'Registry revision',
  },
  ko: {
    ...
    local_install_notice: '설치는 명시적 확인 후 로컬 DSH Runtime에서만 실행됩니다.', stars: 'Stars', updated: '업데이트', back_marketplace: '← 마켓플레이스', footer_summary: 'DSH Marketplace · Registry V4 · 로컬 실행 전용', registry_revision: 'Registry revision',
  },
  es: {
    ...
    local_install_notice: 'La instalación solo se ejecuta en el Runtime DSH local después de una confirmación explícita.', stars: 'Stars', updated: 'Actualizado', back_marketplace: '← Marketplace', footer_summary: 'DSH Marketplace · Registry V4 · ejecución local únicamente', registry_revision: 'Revisión del Registry',
  },
