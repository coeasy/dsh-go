...
describe('no legacy compatibility surfaces', () => {
  it('does not retain obsolete Runtime, Registry, Sync, Search, API, marketplace, deployment or ecosystem runtimes', async () => {
    const forbidden = [
      ...
      'functions/api/_api-v2.ts',
      'functions/api/_lib.ts',
      'functions/api/_registry-v4.ts',
      'functions/api/_registry-v4-query.ts',
      'functions/packages/protocol-core/index.mjs',
      'functions/packages/protocol-core/index.d.mts',
      'runtime/v3',
      ...
      'runtime/localization-overlay.mjs',
      ...
      'schemas/localization-overlay-v1.schema.json',
      'catalog/localization-v1',
